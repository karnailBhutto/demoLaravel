...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
   ...
   <!-- Morris chart -->
   <link rel="stylesheet" href="{{ asset('public/backend/bower_components/morris.js/morris.cs') }}s">
   <!-- jvectormap -->
        ...
        <div class="navbar-custom-menu">
         ...
         <!--  <li class="dropdown messages-menu">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('public/backend/images/profile/') }}/{{ Auth::user()->image }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">

              <li class="user-header">
                <img src="{{ asset('public/backend/images/profile/') }}/{{ Auth::user()->image }}" class="img-circle" alt="User Image">
       ...
       <!--        <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                 ...
                 <a class="btn btn-default btn-flat" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" data-close="true"> Sign out </a>
